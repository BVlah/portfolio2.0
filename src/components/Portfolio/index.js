  ...
  return (
    ...
    <svg class="icons" display='none'>
      <symbol id="arrow-left" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        <polyline points='328 112 184 256 328 400' fill='none' stroke='#fff' strokeLinecap='round' strokeLinejoin='round' strokeWidth='48px'/>
      </symbol>
      <symbol id="arrow-right" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        <polyline points='184 112 328 256 184 400' fill='none' stroke='#fff' strokeLinecap='round' strokeLinejoin='round' strokeWidth='48px'/>
      </symbol>
    </svg>
